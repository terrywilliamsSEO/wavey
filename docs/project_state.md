...
- Run folder: `runs\isochronous_cubic_anchor_3d_20260621_184841`
- Classification: `memory_only_anchor_tradeoff`.
...
- `isochronous_cubic_anchor_supported`: anchor beats neutral/randomized on memory, preserves strict `9/8` or better, keeps comb score near neutral, does not worsen off-comb energy, and passes clean gates.
- `memory_only_anchor_tradeoff`: anchor improves memory but still sacrifices strict count, comb score, or off-comb energy.
- `no_isochronous_anchor_signal`: anchor does not beat controls.
- `invalid_anchor_test`: artifacts, accounting, or clean gates fail.

Result details:

- Neutral reference: memory `0.486969`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.726785`, off-comb `0.156175`, clean gates passed.
- Standard cubic split `0.5x`: memory `0.548333`, strict/default/loose `8/7`, `9/8`, `10/9`, comb `0.505983`, off-comb `0.126943`, clean gates passed.
- Standard cubic split `1.0x`: memory `0.645969`, strict/default/loose `8/7`, `9/8`, `10/9`, comb `0.502308`, off-comb `0.127659`, clean gates passed.
- Radial compensation only: memory `0.544576`, strict/default/loose `6/5`, `9/8`, `9/8`, comb `0.682913`, off-comb `0.157394`, clean gates failed; this diagnostic-row failure does not invalidate required controls or anchor rows after the classifier fix.
- Isochronous anchor `0.5x`: memory `0.631984`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.723992`, off-comb `0.170717`, clean gates passed. It beats neutral by `0.145015` and matched randomized `0.5x` by `0.151180`, but off-comb is worse by `0.014542`.
- Isochronous anchor `1.0x`: memory `0.636308`, strict/default/loose `8/7`, `10/9`, `11/10`, comb `0.730384`, off-comb `0.159108`, clean gates passed. It beats neutral and randomized `1.0x`, but strict count and off-comb still trade down.
- Randomized matched-strength `0.5x`: memory `0.480804`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.725989`, off-comb `0.155867`, clean gates passed.
- Randomized matched-strength `1.0x`: memory `0.476312`, strict/default/loose `9/8`, `9/8`, `11/10`, comb `0.673554`, off-comb `0.255892`, clean gates passed.
...
### Isochronous Anchor Cleanup Control
...
- Run folder: `runs\isochronous_anchor_cleanup_3d_20260621_193641`
- Classification: `cleanup_memory_only_tradeoff`.
- Fixed `41^3` cleanup control under the independent spatial-memory branch.
- Not a continuation or rescue of the closed passive scale-lift branch.
- No optional `51^3` path exists for this command.

Mechanism:

- Tests smooth-taper variants of the compensated cubic memory anchor.
- The intent is to keep the `isochronous_anchor_0p5x` memory, strict-count, and comb improvements while reducing the small off-comb penalty.
- This is implemented as passive lattice stiffness profiles only; it does not add source shaping, active pulses, resonators, or medium-shaping sweeps.
...
- `isochronous_anchor_cleanup_supported`: a cleanup row beats neutral/random on memory, preserves strict `9/8`, keeps comb near neutral, has off-comb <= neutral + fixed tolerance, and passes clean gates.
- `cleanup_memory_only_tradeoff`: memory, strict count, and comb remain good, but off-comb still worsens beyond tolerance.
- `cleanup_no_signal`: cleanup rows lose the memory advantage or do not beat controls under strict/comb constraints.
- `invalid_cleanup_test`: required controls, artifacts, accounting, or clean gates fail.

Result details:

- Neutral reference: memory `0.486969`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.726785`, off-comb `0.156175`, clean gates passed.
- Randomized matched `0.5x`: memory `0.480804`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.725989`, off-comb `0.155867`, clean gates passed.
- Current `isochronous_anchor_0p5x` reference: memory `0.631984`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.723992`, off-comb `0.170717`, clean gates passed.
- `isochronous_anchor_0p5x_smooth_taper`: memory `0.545418`, strict/default/loose `8/7`, `9/8`, `10/9`, comb `0.506173`, off-comb `0.126083`, clean gates passed. It reduces off-comb below neutral but loses strict `9/8` and near-neutral comb.
- `isochronous_anchor_0p5x_wide_smooth_taper`: memory `0.631012`, strict/default/loose `9/8`, `10/9`, `12/11`, comb `0.724866`, off-comb `0.171705`, clean gates passed. It preserves the memory/strict/comb gains but off-comb remains worse than neutral by `0.015530`.
- `isochronous_anchor_0p5x_weaker_compensation`: memory `0.551799`, strict/default/loose `8/7`, `9/8`, `10/9`, comb `0.505587`, off-comb `0.127034`, clean gates passed. It reduces off-comb below neutral but loses strict `9/8` and near-neutral comb.
- `smooth_radial_compensation_only`: memory `0.520905`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.727658`, off-comb `0.150106`, clean gates passed. This diagnostic row is clean and off-comb-low but only weakly improves memory.
...
- Run folder: `runs\angular_mode_cleanup_3d_20260621_210741`
- Classification: `angular_cleanup_memory_only_tradeoff`.
...
- Neutral reference: memory `0.486969`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.726785`, off-comb `0.156175`, clean gates passed.
- Randomized equivalent `0.5x`: memory `0.480804`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.725989`, off-comb `0.155867`, clean gates passed.
- Current `isochronous_anchor_0p5x` reference: memory `0.631984`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.723992`, off-comb `0.170717`, clean gates passed.
- `angular_cleanup_only_weak`: memory `0.543917`, strict/default/loose `6/5`, `9/8`, `9/8`, comb `0.697459`, off-comb `0.210416`, clean gates passed. It did not preserve strict `9/8` and worsened off-comb.
- `anchor_0p5x_weak_angular_cleanup`: memory `0.601371`, strict/default/loose `7/6`, `9/8`, `10/9`, comb `0.697852`, off-comb `0.204026`, clean gates passed. It beat neutral, random `0.5x`, and randomized damping on memory, but lost strict `9/8` and worsened off-comb by `0.033308` versus the anchor reference.
...
- Run folder: `runs\sacred_geometry_memory_anchor_3d_20260701_154048`
- Classification: `sacred_geometry_memory_only_tradeoff`.
- Fixed `41^3` passive mechanism control under the independent spatial-memory branch.
- Not a continuation or rescue of the closed passive scale-lift branch.
- No optional `51^3` path exists for this command.
...
- Neutral reference: memory `0.486969`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.726785`, off-comb `0.156175`, pattern proxy `0.690251`, clean gates passed.
- Current `isochronous_anchor_0p5x` reference: memory `0.631984`, strict/default/loose `9/8`, `10/9`, `11/10`, comb `0.723992`, off-comb `0.170717`, pattern proxy `0.702663`, clean gates passed.
- `icosahedral_shell_anchor`: memory `0.563527`, strict/default/loose `7/6`, `9/8`, `10/9`, comb `0.583307`, off-comb `0.073458`, pattern proxy `0.758087`, clean gates passed. It reduced off-comb and improved coherence, but lost strict `9/8` and near-neutral comb.
- `dodecahedral_shell_anchor`: memory `0.580694`, strict/default/loose `7/6`, `9/8`, `10/9`, comb `0.582903`, off-comb `0.072026`, pattern proxy `0.764014`, clean gates passed. It behaved similarly to icosahedral with slightly better memory/proxy and slightly lower off-comb.
- `golden_ratio_double_shell_anchor`: memory `0.690023`, strict/default/loose `7/6`, `9/8`, `10/9`, comb `0.546204`, off-comb `0.094257`, pattern proxy `0.799234`, clean gates passed. It beat neutral, randomized, and isochronous anchor on memory and reduced off-comb versus the anchor by `0.076460`, but failed strict and comb support gates.
...
- Run complete: `runs\golden_cubic_hybrid_anchor_3d_20260701_162316`.
- Report path: `runs\golden_cubic_hybrid_anchor_3d_20260701_162316\golden_cubic_hybrid_report.md`.
- Classification: `hybrid_memory_only_tradeoff`.
- Fixed `41^3` passive mechanism control under the independent spatial-memory branch.
- Not a continuation or rescue of the closed passive scale-lift branch.
- No optional `51^3` path exists for this command.
...
- Best hybrid: `hybrid_cubic_0p5x_golden_0p5x`.
- Neutral memory/strict/default/loose/comb/off-comb: `0.486969`, `9/8`, `10/9`, `11/10`, `0.726785`, `0.156175`.
- Randomized matched hybrid control memory/strict/default/loose/comb/off-comb: `0.508722`, `9/8`, `9/8`, `11/10`, `0.673755`, `0.255517`.
- Isochronous anchor reference memory/strict/default/loose/comb/off-comb: `0.631984`, `9/8`, `10/9`, `11/10`, `0.723992`, `0.170717`.
