...
- No passive scale-lift physics step is currently justified. The allowed smooth-envelope candidate and the measured patch-level phase-conjugate mirror have both run and failed the joint count-plus-coherence gates; do not broaden either into a sweep.
